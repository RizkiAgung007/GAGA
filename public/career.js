...
<h1 class="text-center pt-4 md:text-2xl text-xs font-bold text-blue">CV dapat dikirimkan melalui email ke <span class= "text-red">recruitment@jakaranatama.co.id</span></h1>`,
    "brand-activation": `
